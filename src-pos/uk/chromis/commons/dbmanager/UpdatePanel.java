...
public class UpdatePanel extends JDialog {
    ...
    private void createPage() {
        ...
        textLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uk/chromis/fixedimages/updaterequired.png")));
        ...
        version.setFont(ChromisFonts.CHROMISFONT.deriveFont(16f));
        dbVersion.setFont(ChromisFonts.CHROMISFONT.deriveFont(16f));
        btnExit.setFont(ChromisFonts.CHROMISFONT.deriveFont(16f));
