...
public class DeviceFiscalPrinterJavaPOS extends javax.swing.JPanel implements DeviceFiscalPrinter  {
    ...
    private void initComponents() {
        ...
        jButton1.setFont(ChromisFonts.DEFAULTBUTTONFONT);
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "*Receipt Title", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, ChromisFonts.DEFAULTFONT.deriveFont(13f)
        ));
        jPanel1.setFont(ChromisFonts.DEFAULTFONT.deriveFont(14f)
        );
        jPanel1.setLayout(null);

        jTextField1.setFont(ChromisFonts.DEFAULTFONT.deriveFont(14f)
        );
        jTextField1.setText("jTextField1");
        jPanel1.add(jTextField1);
        jTextField1.setBounds(20, 30, 260, 25);

        jTextField2.setFont(ChromisFonts.DEFAULTFONT.deriveFont(14f)
        );
        jTextField2.setText("jTextField2");
        jPanel1.add(jTextField2);
        jTextField2.setBounds(20, 60, 260, 25);

        jTextField3.setFont(ChromisFonts.DEFAULTFONT.deriveFont(14f)
        );
        jTextField3.setText("jTextField3");
        jPanel1.add(jTextField3);
        jTextField3.setBounds(20, 90, 260, 25);

        jTextField4.setFont(ChromisFonts.DEFAULTFONT.deriveFont(14f)
        );
        jTextField4.setText("jTextField4");
        jPanel1.add(jTextField4);
        jTextField4.setBounds(20, 120, 260, 25);

        jTextField5.setFont(ChromisFonts.DEFAULTFONT.deriveFont(14f)
        );
        jTextField5.setText("jTextField5");
        jPanel1.add(jTextField5);
        jTextField5.setBounds(20, 150, 260, 25);

        jButton2.setFont(ChromisFonts.DEFAULTBUTTONFONT);
