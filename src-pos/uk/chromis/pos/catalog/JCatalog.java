...
//add in products to the products panel                
    ...
    private void initComponents() {
        ...
        m_jCategories.setFont(ChromisFonts.DEFAULTFONTBOLD);
        ...
        m_jRootCategories.setFont(ChromisFonts.DEFAULTFONT.deriveFont(12f)
        );
        ...
        m_jscrollcat.setFont(ChromisFonts.DEFAULTFONT.deriveFont(12f)
        );

        m_jListCategories.setFont(ChromisFonts.DEFAULTFONT.deriveFont(14f)
        );
        ...
        m_jSubCategories.setFont(ChromisFonts.DEFAULTFONT.deriveFont(12f)
        );
        ...
        m_jProducts.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(18f ));
