...
import uk.chromis.pos.datalogic.DataLogicPresenceManagement;
...
public class JPanelEmployeePresence extends javax.swing.JPanel implements JPanelView, BeanFactoryApp {
    ...
    public void init(AppView app) throws BeanFactoryException {
        this.app = app;
                dlpresencemanagement = (DataLogicPresenceManagement) app.getBean("uk.chromis.pos.datalogic.DataLogicPresenceManagement");
    }
    ...
    private void initComponents() {
        ...
        btnCheckIn.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(22f));
        ...
        btnCheckOut.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(22f));
        ...
        jScrollPane1.setFont(ChromisFonts.DEFAULTFONT.deriveFont(14f));
        jScrollPane1.setPreferredSize(new java.awt.Dimension(570, 120));

        message.setFont(ChromisFonts.DEFAULTFONT);
