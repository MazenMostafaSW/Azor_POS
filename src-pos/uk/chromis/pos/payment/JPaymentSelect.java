...
public abstract class JPaymentSelect extends javax.swing.JDialog implements JPaymentNotifier {
        ...
        if (AppUser.hasPermission(jpay.getKey())) {
            if (!jpay.getKey().equals("payment.loyalty") || (jpay.getKey().equals("payment.loyalty")
                ...
                if (!SystemProperty.PAYMENTICONS) {
                    m_jTabPayment.setFont(ChromisFonts.DEFAULTFONT.deriveFont(20f));
                }
            }
    ...
    private void initComponents() {
        ...
        m_jLblTotalEuros1.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(18f)
        );
        m_jLblTotalEuros1.setText(AppLocal.getIntString("label.totalcash"));
        jPanel4.add(m_jLblTotalEuros1);

        m_jTotalEuros.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(18f)
        );
        ...
        jHandingFees.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(18f));
        jHandingFees.setText(AppLocal.getIntString("label.cardhandling"));
        jPanel4.add(jHandingFees);

        m_jHandlingFee.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(18f)
        );
        ...
        m_jLblRemainingEuros.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(18f)
        );
        m_jLblRemainingEuros.setText(AppLocal.getIntString("label.remainingcash"));
        jPanel4.add(m_jLblRemainingEuros);

        m_jRemainingBalance.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(18f)
        );
        ...
        m_jCardSurcharge.setFont(ChromisFonts.DEFAULTBUTTONFONT);
        ...
        m_jGiftReceipt.setFont(ChromisFonts.DEFAULTBUTTONFONT);
        ...
        m_jCancel.setFont(ChromisFonts.DEFAULTBUTTONFONT);
        ...
        m_jOK.setFont(ChromisFonts.DEFAULTBUTTONFONT);
