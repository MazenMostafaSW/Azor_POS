...
import uk.chromis.pos.giftcards.GiftCardInfo;
...
import uk.chromis.pos.loyalty.LoyaltyCard;
...
//    }
    ...
    private void initComponents() {
        ...
        m_jCardNumber = new uk.chromis.editor.JEditorGiftCard();

        setLayout(new java.awt.BorderLayout());

        jPanel5.setLayout(new java.awt.BorderLayout());

        jPanel4.setFont(ChromisFonts.DEFAULTFONT.deriveFont(14f)
        );
        jPanel4.setPreferredSize(new java.awt.Dimension(0, 40));
        jPanel4.setLayout(null);

        jLabel8.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(22f)
        );
        ...
        m_jMoneyEuros.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(22f)
        );
        ...
        jCardNumber.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(22f)
        );
        ...
        jBalanceBtn.setFont(ChromisFonts.DEFAULTBUTTONFONT);
        ...
        m_jTendered.setFont(ChromisFonts.DEFAULTFONT.deriveFont(18f)
        );
        ...
        m_jCardNumber.setFont(ChromisFonts.DEFAULTFONT.deriveFont(12f));
    ...
    private uk.chromis.editor.JEditorGiftCard m_jCardNumber;
