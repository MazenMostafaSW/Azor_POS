...
import uk.chromis.pos.sales.CustomerDisplay;
...
public class JTicketsBagShared extends JTicketsBag {
    ...
    public JTicketsBagShared(AppView app, TicketsEditor panelticket) {
        ...
        dlSales = (DataLogicSales) app.getBean("uk.chromis.pos.datalogic.DataLogicSales");
    ...
    public void activate() {
        m_sCurrentTicket = null;
        selectValidTicket();
        m_jDelTicket.setEnabled(AppUser.hasPermission("uk.chromis.pos.sales.JPanelTicketEdits"));
        checkLayaways();
    }
    ...
    private void initComponents() {
        ...
        m_jListTickets.setFont(ChromisFonts.DEFAULTFONTBOLD);
        m_jListTickets.setIcon(IconFactory.getIcon("sale_pending.png"));
