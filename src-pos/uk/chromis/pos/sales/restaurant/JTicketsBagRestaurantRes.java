...
public class JTicketsBagRestaurantRes extends javax.swing.JPanel {
    ...
    public JTicketsBagRestaurantRes(AppView oApp, JTicketsBagRestaurantMap restaurantmap) {
        ...
        dlCustomers = (DataLogicCustomers) oApp.getBean("uk.chromis.pos.datalogic.DataLogicCustomers");
    ...
    private void createListPanel(Integer width, Integer height) {
        ...
        jListReservations.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(20f));
    ...
    private void initComponents() {
        ...
        m_jbtnTables.setFont(ChromisFonts.DEFAULTBUTTONFONT);
        ...
        m_jbtnAddReservation.setFont(ChromisFonts.DEFAULTBUTTONFONT);
        ...
        basePanel.setFont(ChromisFonts.DEFAULTFONT.deriveFont(13f)
        );
        ...
        basePanel1.setFont(ChromisFonts.DEFAULTFONT.deriveFont(13f)
        );
