...
public class JGiftCardEdit extends javax.swing.JDialog {
  ...
  //  private SentenceList senttax;
    ...
    private void initComponents() {
        ...
        m_jAmount = new uk.chromis.editor.JEditorCurrency();
        ...
        jLblAmount.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(20f)
        );
        jLblAmount.setText(AppLocal.getIntString("label.units")); // NOI18N
        jPanel2.add(jLblAmount);
        jLblAmount.setBounds(10, 80, 140, 25);

        jLblCardNumber.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(20f));
        ...
        m_jMoneyEuros.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(20f));
        ...
        m_jCardNumber.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(20f));
        ...
        jLblExisting.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(20f)
        );
        ...
        jLblExistingAmount.setFont(ChromisFonts.DEFAULTFONTBOLD.deriveFont(20f));
        ...
        m_jButtonCancel.setFont(ChromisFonts.DEFAULTBUTTONFONT);
        ...
        m_jButtonOK.setFont(ChromisFonts.DEFAULTBUTTONFONT);
    ...
    private uk.chromis.editor.JEditorCurrency m_jAmount;
