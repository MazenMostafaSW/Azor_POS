...
public class ScaleAdam implements Scale, SerialPortEventListener {
    ...
    private void showDialog() {
        ...
        UIManager.put("OptionPane.buttonFont", new FontUIResource(ChromisFonts.DEFAULTFONT.deriveFont(22f)));
        String message =  AppLocal.getIntString("scale.weighitem");
        JLabel FontText = new JLabel(message);
        FontText.setFont (ChromisFonts.DEFAULTFONTBOLD.deriveFont(38f) );
