...
public class JPanelCloseMoney extends JPanel implements JPanelView, BeanFactoryApp {
    ...
    public void init(AppView app) throws BeanFactoryException {
        ...
        dbQuery = (DataLogicSystem) app.getBean("uk.chromis.pos.datalogic.DataLogicSystem");
...
// read number of no sale activations 
    ...
    private void initComponents() {
        ...
        jPanel1.setFont(ChromisFonts.DEFAULTFONT.deriveFont(12f));
        jPanel1.setPreferredSize(new java.awt.Dimension(931, 650));

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, AppLocal.getIntString("label.datestitle"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, ChromisFonts.DEFAULTFONTBOLD)); // NOI18N

        jLabel11.setFont(ChromisFonts.DEFAULTFONT);
        jLabel11.setText(AppLocal.getIntString("label.sequence")); // NOI18N

        m_jSequence.setEditable(false);
        m_jSequence.setFont(ChromisFonts.DEFAULTFONT);
        m_jSequence.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

        jLabel2.setFont(ChromisFonts.DEFAULTFONT);
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel2.setText(AppLocal.getIntString("label.startDate")); // NOI18N

        m_jMinDate.setEditable(false);
        m_jMinDate.setFont(ChromisFonts.DEFAULTFONT);
        m_jMinDate.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

        jLabel3.setFont(ChromisFonts.DEFAULTFONT);
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText(AppLocal.getIntString("label.endDate")); // NOI18N

        m_jMaxDate.setEditable(false);
        m_jMaxDate.setFont(ChromisFonts.DEFAULTFONT);
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, AppLocal.getIntString("label.paymentstitle"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, ChromisFonts.DEFAULTFONTBOLD)); // NOI18N
        jPanel5.setFont(ChromisFonts.DEFAULTFONT.deriveFont(12f)
        );
        jPanel5.setPreferredSize(new java.awt.Dimension(879, 480));

        m_jScrollTableTicket.setBorder(null);
        m_jScrollTableTicket.setFont(ChromisFonts.DEFAULTFONTBOLD);
        ...
        m_jTicketTable.setFont(ChromisFonts.DEFAULTFONT.deriveFont(15f));
        ...
        m_jPrintCash.setFont(ChromisFonts.DEFAULTBUTTONFONT.deriveFont(16f));
        ...
        m_jPreviewCash.setFont(ChromisFonts.DEFAULTBUTTONFONT.deriveFont(16f));
        ...
        m_jCloseCash.setFont(ChromisFonts.DEFAULTBUTTONFONT.deriveFont(16f));
        ...
        btnReloadDay.setFont(ChromisFonts.DEFAULTBUTTONFONT.deriveFont(16f)
        );
        ...
        btnResetDay.setFont(ChromisFonts.DEFAULTBUTTONFONT.deriveFont(16f));
