...
public class JPanelPayments extends JDialog {
    ...
    private final Font lblFont = ChromisFonts.DEFAULTFONT;
    private final Font txtFont = ChromisFonts.DEFAULTFONT;
    private final Font btnFont = ChromisFonts.DEFAULTFONT;
    ...
    private void showPaymentPanel() {
        ...
        paymentReason.setFont(ChromisFonts.DEFAULTFONTBOLD);
        ...
        inputValue.setFont(ChromisFonts.DEFAULTFONTBOLD);
